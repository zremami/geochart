...
<script>
  ...
  export default {
    ...
    {
      setTimeout(() => {
        this.urlEdit("https://www.imis.bfs.de/ogc/opendata/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=opendata:nuklide_fleisch&CQL_FILTER=(sample_begin%20DURING%202020-12-08T12%3A00%3A00.000Z%2F2021-01-08T12%3A00%3A00.000Z)%20AND%20(nuclide%3D%27Ce-144%27%20OR%20nuclide%3D%27Cs-137%27%20OR%20nuclide%3D%27Cs-134%27%20OR%20nuclide%3D%27Ru-103%27%20OR%20nuclide%3D%27I-131%27%20OR%20nuclide%3D%27Co-60%27)&VIEWPARAMS=order:sample_begin;&outputFormat=application%2Fjson");
        //this.urlEdit();
      }, 1000);
    },
    methods:{
